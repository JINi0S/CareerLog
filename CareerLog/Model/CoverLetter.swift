...
struct CoverLetterContent: Equatable {
    let id: Int
    var coverLetterId: Int
    var question: String
    var tag: [CoverLetterTag]
    var answers: [String]
...
extension CoverLetterContent {
    ...
    static let naverContents = [
        ...
        CoverLetterContent(
            id: 2, coverLetterId: 3,
            question: "본인의 역량을 설명해주세요.", tag: [],
            answers: [
    ...
    static let tossContents = [
        CoverLetterContent(
            id: 4, coverLetterId: 2,
            question: "본인의 성장 경험을 알려주세요.", tag: [],
            answers: [
...
extension CoverLetter {
    // 자기소개서 인스턴스
    static let coverLetter1 = CoverLetter(id: 1, company: "네이버", title: "네이버 백엔드 자기소개서", contents: CoverLetterContent.naverContents, state: .draft, isBookmarked: true, dueDate: .now, jobPosition: "iOS 개발자")
    static let coverLetter2 = CoverLetter(id: 2, company: "카카오", title: "카카오 iOS 자기소개서", contents: CoverLetterContent.kakaoContents, state: .submitted, dueDate: .now, jobPosition: "iOS 개발자")
    static let coverLetter3 = CoverLetter(id: 3, company: "토스", title: "토스 신입 개발자 자기소개서", contents: CoverLetterContent.tossContents, state: .unwrite, dueDate: .now, jobPosition: "iOS 개발자")
    static let coverLetter4 = CoverLetter(id: 4, company: "코오롱", title: "코오롱 신입 개발자 자기소개서", contents: CoverLetterContent.tossContents, state: .passed, dueDate: .now, jobPosition: "iOS 개발자")
    static let coverLetter5 = CoverLetter(id: 5, company: "쿠팡", title: "쿠팡 신입 개발자 자기소개서", contents: CoverLetterContent.tossContents, state: .failed, dueDate: .now, jobPosition: "iOS 개발자")
